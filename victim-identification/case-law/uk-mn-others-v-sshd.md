...
```yaml
title: "MN and Others v. SSHD [2020] EWCA Civ 1746 (NRM Decisions)"
jurisdiction: UK
bucket: case-law
document_type: judgment-opinion
issuing_body: "Court of Appeal (Civil Division)"
date_issued: 2020-12-21
status: current
source_url: ""
access: backend-needed

backend_source: BAILII
backend_confidence: likely-exists-needs-verification
retrieval_notes: >
  MN and Others v Secretary of State for the Home Department [2020] EWCA Civ 1746.
  Available on BAILII at https://www.bailii.org/ew/cases/EWCA/Civ/2020/1746.html.
  Verify whether full text is freely accessible or requires institutional login.

summary: >
  Court of Appeal challenge to the NRM decision-making process and the Competent Authority's
  standard of proof for victim identification. Held that the Competent Authority must
  properly engage with expert evidence and give adequate reasons when rejecting claims of
  trafficking, reinforcing procedural fairness standards in conclusive grounds decisions.
